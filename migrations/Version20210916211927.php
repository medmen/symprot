 ...
 */
final class Version20210916211927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__geraet AS SELECT geraet_id, geraet_name, geraet_beschreibung FROM geraet');
        ...
        $this->addSql('INSERT INTO geraet (geraet_id, geraet_name, geraet_beschreibung) SELECT geraet_id, geraet_name, geraet_beschreibung FROM __temp__geraet');
        ...
        $this->addSql('CREATE TABLE parameter (parameter_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, geraet_id INTEGER NOT NULL, parameter_name CLOB DEFAULT NULL COLLATE BINARY, parameter_selected INTEGER DEFAULT NULL, parameter_default INTEGER DEFAULT NULL, CONSTRAINT FK_2A979110D2D09835 FOREIGN KEY (geraet_id) REFERENCES geraet (geraet_id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image_name VARCHAR(255) NOT NULL COLLATE BINARY, image_size INTEGER NOT NULL, updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
