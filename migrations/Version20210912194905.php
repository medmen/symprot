 ...
 */
final class Version20210912194905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE protocol (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, protocol_name VARCHAR(255) NOT NULL, protocol_size INTEGER NOT NULL, protocol_mime_type VARCHAR(255) NOT NULL, protocol_orig_name VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL)');
    }
